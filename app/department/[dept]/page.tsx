...
export default function DepartmentPage() {
  ...
  useEffect(() => {
    ...
    try {
      const allKPIs: KPI[] = [];
      const filteredExecutives = executives.filter((e) => e.department === department.name);
      ...
      <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <Icon className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600 dark:text-blue-400 flex-shrink-0" />
          ...
          {/* 월별 선택 */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-4 border border-gray-200 dark:border-gray-700 mb-4 sm:mb-6">
            <label htmlFor="month-select" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              조회 월
            </label>
            <select
              id="month-select"
              ...
              className="w-full px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">담당자 수</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                {deptExecutives.length}명
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">전체 KPI</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{kpis.length}개</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">평균 달성률</p>
              <p className="text-xl sm:text-2xl font-bold text-blue-600 dark:text-blue-400">
                {avgProgress.toFixed(1)}%
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">정상 진행</p>
